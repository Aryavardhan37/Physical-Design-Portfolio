...
export const SKILLS_DATA = [
  {
    ...
    icon: "\u2699\ufe0f",
    color: "cyan",
    skills: ["Fusion Compiler", "IC Compiler 2", "PrimeTime", "Design Compiler", "Formality", "IC Validator", "OpenLane", "OpenROAD", "Yosys", "Magic", "KLayout", "Netgen", "OpenSTA"],
  },
  {
    category: "Programming & HDLs",
    icon: "\ud83d\udcbb",
    color: "magenta",
    skills: ["Verilog", "SystemVerilog", "TCL", "Python", "Perl", "Shell Scripting"],
  },
  {
  ...
  },
  {
    ...
    icon: "\ud83d\udd27",
    color: "cyan",
    skills: ["Jetson Nano", "Raspberry Pi 4", "Arduino", "ESP8266"],
  },
  {
    category: "PDKs & Flows",
    icon: "\ud83c\udfed",
...
export const PROJECTS_DATA = [
  {
    id: 1,
    title: "I2C Protocol on FPGA — RTL to GDS",
    subtitle: "Capstone Project — VLSI Physical Design",
    description: "Designed and implemented I2C master/slave controllers using Verilog FSMs, deployed on Xilinx Nexys 4 DDR FPGA with ADT7420 temperature sensor interfacing. Explored full RTL-to-GDS flow using Yosys, OpenLane, and OpenTimer.",
    techStack: ["Verilog", "Xilinx FPGA", "Vivado", "Yosys", "OpenLane", "ModelSim"],
    link: "#",
    color: "cyan",
  },
  {
    id: 2,
    title: "Open-Source PD Flow — UART in picoSoC",
    subtitle: "Industry Project @ Einfochips — RTL to GDSII",
    description: "End-to-end open-source ASIC physical design flow for a UART block in picoSoC using OpenLANE and OpenROAD on SkyWater 130nm PDK. Covered synthesis, floorplanning, placement, CTS, routing, and signoff with DRC/LVS clean results.",
    techStack: ["OpenLANE", "OpenROAD", "Yosys", "TritonCTS", "TritonRoute", "Magic", "SkyWater 130nm"],
    link: "#",
    color: "magenta",
  },
  {
