          ...
          <section id="materials" className="py-12">
            <div className="max-w-6xl mx-auto px-6">
              ...
              <div className="text-center mb-8">
                <h2 className="section-heading gradient-text">Materials</h2>
                ...
                {MATERIALS_DATA.map((item, i) => (
                  <div key={i} className="glass rounded-2xl p-6 card-hover flex flex-col">
                    ...
                    <a
                      href={item.file}
                      download
                      className="mt-auto text-sm font-medium px-4 py-2 rounded-full text-center transition-all"
                      style={{
